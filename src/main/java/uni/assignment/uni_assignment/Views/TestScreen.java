 ...
 */
package uni.assignment.uni_assignment.Views;

import java.util.List;
import uni.assignment.uni_assignment.Models.DB;
import uni.assignment.uni_assignment.Models.User;
...
public class TestScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        UsernameField.setText("UsernameBox");

        PasswordField.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        PasswordField.setText("PasswordBox");
    ...
    private void LoginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginButtonActionPerformed
        DB db = new DB();
        db.getConnection();
        List<User> user = db.where("username=?", UsernameField.getText().trim()).results(User.class);
        System.out.println(user.get(0).getPassword());
        if (user.get(0).getPassword().equals(PasswordField.getText().trim())) {
